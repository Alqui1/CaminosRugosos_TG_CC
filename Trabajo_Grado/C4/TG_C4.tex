...
Con esto, obtener otra cota para la norma $\alpha$-Hólder de $X$:
...
Con esto, queda probado que $\lVert K_{\alpha} \rVert_{L^q}$. Ahora, queda probar el resultado análogo para la variable aleatoria $\mathbb{K}_{\alpha}$.
